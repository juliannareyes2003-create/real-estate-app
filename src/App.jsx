      ...
      <main style={{ maxWidth: "1240px", margin: "0 auto", padding: "42px 24px 80px" }}>
        ...
        >
          ...
          <h2 style={{ fontSize: "34px", marginBottom: "12px" }}>
            A simpler walkthrough from the first screen
          </h2>
          <p
            style={{
              fontSize: "17px",
          ...
          >
            The platform is designed so beginners can understand the purpose right away. You do not need to know
            industry terms or define your professional role before getting value.
          </p>
            ...
            {[
              {
                ...
                body: "See the learning topics, newsletters, and community before making an account.",
              },
              {
                title: "Choose what you want to learn",
                body: "Start with a goal like learning the basics, investing, or regulations.",
              },
              {
                title: "Get guided support",
                body: "Read beginner-friendly content and connect with professionals when you need deeper help.",
              },
            ].map((item) => (
              <div
                key={item.title}
